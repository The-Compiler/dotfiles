...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(
       ...
       (bbcode-mode :location (recipe :fetcher bitbucket :repo "jfm/emacs-bbcode"))
       feature-mode
       form-feed
       evil-collection
   )
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Iosevka Nerd Font:style=Thin"
                               :size 18
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
...
before packages are loaded."
  ...
  (defun LaTex-screenshot ()
    ...
    (let ((filename (concat (read-file-name "Enter file name:") ".png")))
      ...
      (call-process "/usr/bin/scrot" nil nil nil "-zs" filename)
